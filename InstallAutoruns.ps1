New-Item -Force -ItemType SymbolicLink -Path $Env:SystemRoot\system32\WindowsPowerShell\v1.0\profile.ps1 -Target $PSScriptRoot\profile.ps1
New-Item -Force -ItemType SymbolicLink -Path $Env:SystemRoot\system32\windows.nt -Target $PSScriptRoot\autorun.bat
Set-ItemProperty -Force -Path "HKLM:\SOFTWARE\Microsoft\Command Processor" -Name "AutoRun" -Value $PSScriptRoot\autorun.bat
New-Item -Force -ItemType SymbolicLink -Path $Env:SystemRoot\system32\WindowsPowerShell\v1.0\autorun.ps1 -Target $PSScriptRoot\profile.ps1
New-Item -Force -ItemType SymbolicLink -Path $Env:SystemRoot\system32\windows.nt -Target $PSScriptRoot\autorun.bat
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUTG58fvHVAjzpCH3pIK9LE/ZF
# eTOgghZEMIIDBjCCAe6gAwIBAgIQfgB16oPhJYdCA8+jPApo0zANBgkqhkiG9w0B
...
# AYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTfpYM5x9bQIU9BtfAf5VgyiYahWzANBgkq
# hkiG9w0BAQEFAASCAQBxPJNkXSm51teF4HHtlTKCHgZ6juAeS9XFwOy5wFrNK2GE
# EQ1cDFlxHvjdzmNipSll9Fw6FJua7LppGBKqsc/0k3EqeUHtjKMtPYDHsIWtBP0h
# p7bPy43cfX2G1OSQuKiHs7/d27uqVdE/UGDfkXfMm6A9UZGBB19BoXAWFlm5S1vv
# ZWvPr/D5rtzWhIO7rYw7kPtruX32xmn8bnSEzyruscjKG6PmYhrClqAf5F7dQVKf
# 6ubuTBsaNu25lfU0f6X3jP6EWTeB2ZVlBrmxok1sDwpnw454stE0jt6ST8KN+bJk
# TydASCUVywL13sUII/cLawNgxulGCvWhgUhN22syoYIDJjCCAyIGCSqGSIb3DQEJ
...
# AQkFMQ8XDTI2MDEwMTIyNDgyOFowLwYJKoZIhvcNAQkEMSIEIHM2FGS1Y80GapTA
# AtE7f6PPwiI+eHiJhfPBtAOjTGOAMA0GCSqGSIb3DQEBAQUABIICAHPS4qum/Rw2
# q5Hlv429LKeH8nexUrv2KIkmC+/Ed0PObIwUjEKKQRqaesYBTeIXfTetU53Nd9QP
# LDohYLT9tbhJFSTgzfA7s2MCU7mE46S52qf2tEKVq9hNDWN0RvJ4j1cR1Agxa+FM
# PM1TVObwj2Qx0NdwENUWEs5ni+y8ZwiufOt31YFsk7SKJepnIf9MF0J5O0LYTBJR
# fXNRkoI4kl5K6tDJTzlzT13TpXnexk4509LPlFTF8qOc+zMQtYYIzlpM9B+JlCsF
# giUBhlLZwuPVAuVVS0pJxlc3l4YVTaKaowzS/omq6kJPJy4C/g5hapNnKFVojIJg
# L+4mWbRZ9mp+ReZ3+ObZnrTMBXOA7sgX5yYfHooGn8dq+bmFu10Vn4WYAH17qd7g
# Sq3fl44SB6WohvvRmoCPxPjCYVpe6D/Zs3PHMztDgqSxOMg+VCqR8sOJ9kVmwddp
# zD3AZ6cBMnHtuLIpK6J+Jea/64/V1aODfXu6z27TssBx3k3Fhu/GQFWlb+P70uyW
# /YU10ZancymwVtiZKgrfGVVbg3InL0CpMhRVchhRHtwP5rfhmjL3uSvvzscG6046
# cZ74YFmxaSyiHg2fS6+JdXbd5/V3eHn6VLudP8DanAjUvcnvN+aLIGJQVJTDGeJx
# sPJZhw6QM/mNtxJIVkMnA31wuhHe5dSx
